...
<form action="/profil/edit/{{ Auth::user()->id }}/proses" method="post">
    ...
    <div class="from">
        ...
        <div class="forin">
            ...
            <input type="text" name="username" placeholder="masukkan Penulis" value="{{ Auth::user()->username }}">
        ...
        <div class="forin">
            ...
            <input type="text" name="email" placeholder="masukkan penerbit"  value="{{ Auth::user()->alamat }}">
        ...
        <div class="forin">
            ...
            <input type="text" name="alamat" placeholder="masukkan Tahun Terbit" value="{{Auth::user()->email }}">
